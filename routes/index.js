...
router.get('/oauth2callback', passport.authenticate(
  'google',
  {
    successRedirect : '/businesses', // where do you want the client to go after you login 
    failureRedirect : '/businesses' // where do you want the client to go if login fails
  }
));
